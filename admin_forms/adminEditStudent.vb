...
Public Class adminEditStudent
    ...
    Private Sub BunifuFlatButton1_Click(sender As Object, e As EventArgs) Handles BunifuFlatButton1.Click
        ...
        Dim result As DialogResult = MessageBox.Show("Delete user 'chamod'?", "Confirmation", MessageBoxButtons.OKCancel)
        ...
        If result = DialogResult.OK Then
            ...
            ResetForm()
        Else
            ' User clicked Cancel or closed the message box, do nothing
        End If
    End Sub
End Class